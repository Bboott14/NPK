...
class Example(QWidget):
    def __init__(self):
        ...
        'Сейчас или никогда', 'Умные нам не надобны надобны верные', 'Нельзя смешивать странное с таинственным',
        'Ведь в медицине чаще всего лечит вера', 'Человек без сюрприза внутри в своём ящике неинтересен',
        'Пустое сердце бьется ровно', 'Это всего лишь жизнь и мы прорвемся', 'Два хороших человека всегда могут договорится',
        ...
        'шкатулка', 'шакал', 'идея', 'глаза', 'телефон', 'забота', 'кубик', 'пересечение', 'полость', 'клоун', 'знамя',
        'Королевство', 'Песня', 'зима', 'природа', 'пожалуйста', 'скрепление', 'программа', 'кино', 'пеликан']
    ...
    def setupUi(self):
        ...
        self.label3.setText("   Тренажер для практики в шифровке и дешифровке текста. \n\n\nСейчас вам предложенно два варианта практики.\n"
        "В первом вариантам вы будете вводить фразу для шифровки или дешифровки, а потом проверять правильность перевода.\n"
